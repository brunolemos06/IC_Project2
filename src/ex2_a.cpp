...
int main(int argc, char** argv )
{
    ...
    //make a negative of the image by copying each pixel

    for(int i = 0; i < image.rows; i++)
    {
        for(int j = 0; j < image.cols; j++)
        {
            image3.at<Vec3b>(i,j)[0] = 255 - image.at<Vec3b>(i,j)[0];
            image3.at<Vec3b>(i,j)[1] = 255 - image.at<Vec3b>(i,j)[1];
            image3.at<Vec3b>(i,j)[2] = 255 - image.at<Vec3b>(i,j)[2];
        }
    }
